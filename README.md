...
<p align="center">
Easy to sell with <a href="https://github.com/3yed-61/wizwizxui-timebot">wizwizxui-timebot</a> easy install with few clicks
</p>
...
```
bash <(curl -s https://raw.githubusercontent.com/3yed-61/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/3yed-61/wizwizxui-timebot/main/update.sh)
```
